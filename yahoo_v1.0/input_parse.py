...
def talk(s):
	...
	if dic['q'] == "":
		...
		ret['statue'] = u"success"
		print "XD"
		ret['response'] = json.dumps(res , ensure_ascii=False ,encoding="utf-8")
		print "XD"
		
	else:
		ret['statue'] = u"unknown"
...
# print talk(s)
A = json.dumps(talk(s) , ensure_ascii=False,encoding='utf-8')
B = json.loads(A)
print B['response']
"""
